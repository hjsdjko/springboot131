...
public class FangyuanxinxiEntity<T> implements Serializable {
	 ...
	 * 设置：每平方价
	 */
	public void setMeipingfangjia(Double meipingfangjia) {
		this.meipingfangjia = meipingfangjia;
	}
	/**
	 * 获取：每平方价
	 */
	public Double getMeipingfangjia() {
		return meipingfangjia;
	}
	/**
	 * 设置：房屋面积
	 */
